...
<div class="container">
        <div class="submenu">
            ...
            <ol class="breadcrumb submenu">
                ...
                <li class="breadcrumb-item active text-dark" aria-current="page">Healthy Eating</li>
            </ol>
            </nav>
        </div>
    <div class="row">
            ...
            include_once ('bonds/config.php');
             $query = "SELECT * FROM post  WHERE category_id=1";
               ...
               while ($row = mysqli_fetch_assoc($query_run))
               {
                 $postid = $row['post_id']; 
                    ?>
                        <div class="col-sm-3">   
                            <div class="">
                            <a href="page_healthyeating.php?id=<?php echo $postid?>" class="healthypost">
                                        <img src="photos/<?php echo $row['post_image'] ?>" class="card-img-top" alt="post picture" width="150px" height="200px">
                                    </a>
                                <div class="card-body">
